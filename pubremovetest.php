...
if ($name['name'] == "Alcohol") {
    ...
    $sql1 = "UPDATE orderslip SET Total = Total - 1 WHERE id=1";
    $result1= $conn->query($sql1);
    $result2= $conn->query($sql2);
}
if ($name['name'] == "Gauze Pad") {
    $sql2 = "UPDATE orderslip SET Gauze_Pad = 0 WHERE id=1";
    $sql1 = "UPDATE orderslip SET Total = Total - 2 WHERE id=1";
    $result1= $conn->query($sql1);
    $result2= $conn->query($sql2);
}
if ($name['name'] == "Tape") {
    $sql2 = "UPDATE orderslip SET Tape = 0 WHERE id=1";
    $sql1 = "UPDATE orderslip SET Total = Total - 3 WHERE id=1";
    $result1= $conn->query($sql1);
    $result2= $conn->query($sql2);
}
if ($name['name'] == "Betadine") {
    $sql2 = "UPDATE orderslip SET Betadine = 0 WHERE id=1";
    $sql1 = "UPDATE orderslip SET Total = Total - 4 WHERE id=1";
    $result1= $conn->query($sql1);
    $result2= $conn->query($sql2);
}
if ($name['name'] == "Cotton") {
    $sql2 = "UPDATE orderslip SET Cotton = 0 WHERE id=1";
    $sql1 = "UPDATE orderslip SET Total = Total - 5 WHERE id=1";
    $result1= $conn->query($sql1);
    $result2= $conn->query($sql2);
}
